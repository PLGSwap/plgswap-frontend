  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Cheaper and faster than Uniswap? Discover PancakeSwap, the leading DEX on POLYGOMIC Smart Chain (BSC) with the best farms in DeFi and a lottery for CAKE."
        />
        ...
        <meta name="twitter:title" content="🥞 PancakeSwap - A next evolution DeFi exchange on POLYGOMIC Smart Chain (BSC)" />
