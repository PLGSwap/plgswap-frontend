import { SerializedFarm } from '@plgswap/farms'
import farms1 from '@plgswap/farms/constants/1'
import farms56 from '@plgswap/farms/constants/56'
import { Native } from '@plgswap/sdk'
