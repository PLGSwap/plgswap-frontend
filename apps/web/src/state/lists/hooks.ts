...
import { TokenAddressMap as TTokenAddressMap, WrappedTokenInfo, TokenList, TokenInfo } from '@plgswap/token-lists'
import { ListsState } from '@plgswap/token-lists/react'
import {
...
import { EMPTY_LIST } from '@plgswap/tokens'
...
function combineMaps(map1: TokenAddressMap, map2: TokenAddressMap): TokenAddressMap {
  return {
    ...
    [ChainId.POLYGOMIC]: { ...map1[ChainId.POLYGOMIC], ...map2[ChainId.POLYGOMIC] },
