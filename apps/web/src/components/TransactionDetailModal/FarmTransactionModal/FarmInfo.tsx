...
import { Box, Text, Flex, Link, useTooltip, LightBulbIcon } from '@plgswap/uikit'
...
const FarmResult: React.FC<React.PropsWithChildren<FarmInfoProps>> = ({ pickedData }) => {
  ...
  const { targetRef, tooltip, tooltipVisible } = useTooltip(
    <Flex flexDirection="column">
      <ListStyle>{t('You have received 0.0005 BNB as a first-time POLYGOMIC Smart Chain user')}</ListStyle>
      <ListStyle>
