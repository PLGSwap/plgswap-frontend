...
import { Text, Flex, Box, Skeleton, TooltipText, useTooltip, IfoSkeletonCardDetails } from '@plgswap/uikit'
import { PublicIfoData, WalletIfoData } from 'views/Ifos/types'
import { useTranslation } from '@plgswap/localization'
import { Ifo, PoolIds } from 'config/constants/types'
import { BIG_ONE_HUNDRED } from '@plgswap/utils/bigNumber'
import { getBalanceNumber, formatNumber } from '@plgswap/utils/formatBalance'
import useBUSDPrice from 'hooks/useBUSDPrice'
import { DAY_IN_SECONDS } from '@plgswap/utils/getTimePeriods'
