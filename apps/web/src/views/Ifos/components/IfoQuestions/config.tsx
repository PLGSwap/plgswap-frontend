...
import { Link } from '@plgswap/uikit'
...
const config = [
  {
    ...
    description: [
      ...
      <Trans>
        In the Public Sale, everyone with an active PlgSwap profile can commit. However the maximum amount of CAKE
  ...
  },
  {
    ...
    description: [
      ...
      <Trans>Just remember you need an active PlgSwap Profile in order to participate.</Trans>,
    ],
  },
  {
