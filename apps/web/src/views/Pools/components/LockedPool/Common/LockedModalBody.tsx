...
import { Button, AutoRenewIcon, Box, Flex, Message, MessageText, Text } from '@plgswap/uikit'
import _noop from 'lodash/noop'
import { useTranslation } from '@plgswap/localization'
import isUndefinedOrNull from '@plgswap/utils/isUndefinedOrNull'
import { MAX_LOCK_DURATION } from 'config/constants/pools'
import BigNumber from 'bignumber.js'
import { getBalanceAmount, getDecimalAmount } from '@plgswap/utils/formatBalance'
