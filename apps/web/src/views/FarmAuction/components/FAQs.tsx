...
import { Text, Heading, Card, CardHeader, CardBody, Flex, Link, Box } from '@plgswap/uikit'
            ...
            <FoldableText title={t('Step 1: Submit application')} mt="24px">
              <Box display="inline">
                <Text display="inline" color="textSubtle">
                  {t('Projects can submit an application to sponsor a yield farm and/or pool on PlgSwap via the ')}
                </Text>
            ...
            <FoldableText title={t('Step 2: Await whitelisting')} mt="24px">
              <Box color="textSubtle">
                <Text color="textSubtle" mb="4px">
                  {t('The PlgSwap team will try to respond within a week.')}
                </Text>
                <List>
                  <FaqLi>
                    {t(
