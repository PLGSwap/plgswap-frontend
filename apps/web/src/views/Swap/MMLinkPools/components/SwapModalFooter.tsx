...
import { AutoRenewIcon, Button, Link, QuestionHelper, Text, AutoColumn, Dots } from '@plgswap/uikit'
              ...
              text={
                <>
                  ...
                  <Text mt="10px">
                    ...
                    :{' '}
                    {t(
                      'PlgSwap does not charge any fees for trades. However, the market makers charge an implied fee of 0.05% (non-stablecoin) / 0.01% (stablecoin) factored into the quotes provided by them.',
                    )}
                  </Text>
                </>
              }
