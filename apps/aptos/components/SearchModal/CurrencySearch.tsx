...
import { useDebounce, useSortedTokensByQuery } from '@plgswap/hooks'
import { createFilterToken } from '@plgswap/utils/filtering'
import { useTranslation } from '@plgswap/localization'
import { AutoColumn, Box, Column, Input, Row, Text, useMatchBreakpoints } from '@plgswap/uikit'
import useActiveWeb3React from 'hooks/useActiveWeb3React'
import useNativeCurrency from 'hooks/useNativeCurrency'
import { KeyboardEvent, RefObject, useCallback, useEffect, useMemo, useRef, useState } from 'react'
import { APTOS_COIN, isStructTag } from '@plgswap/awgmi'
