...
export const SEO: DefaultSeoProps = {
  ...
  description:
    'Cheaper and faster than Uniswap? Discover PancakeSwap, the leading DEX on POLYGOMIC Smart Chain (BSC) with the best farms in DeFi and a lottery for CAKE.',
  twitter: {
  ...
  openGraph: {
    title: '🥞 PancakeSwap - A next evolution DeFi exchange on POLYGOMIC Smart Chain (BSC)',
    description:
