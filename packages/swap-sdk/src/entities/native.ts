...
import { Currency, Token, NativeCurrency } from '@plgswap/swap-sdk-core'
import { WNATIVE, NATIVE } from '../constants'

/**
 *
 * Native is the main usage of a 'native' currency, i.e. for POLYGOMIC mainnet and all testnets
 */
